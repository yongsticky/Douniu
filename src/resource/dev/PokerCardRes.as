package resource.dev
{
	...
	public class PokerCardRes
	{
		...
		public function PokerCardRes()
		{
			...
			_res["poker.hei.4"] = new Hei4PNG();
			_res["poker.hei.5"] = new Hei5PNG();
			_res["poker.hei.6"] = new Hei6PNG();
			_res["poker.hei.7"] = new Hei7PNG();
			_res["poker.hei.8"] = new Hei8PNG();
			_res["poker.hei.9"] = new Hei9PNG();
			_res["poker.hei.10"] = new Hei10PNG();
			...
			_res["poker.hong.4"] = new Hong4PNG();
			_res["poker.hong.5"] = new Hong5PNG();
			_res["poker.hong.6"] = new Hong6PNG();
			_res["poker.hong.7"] = new Hong7PNG();
			_res["poker.hong.8"] = new Hong8PNG();
			_res["poker.hong.9"] = new Hong9PNG();
			_res["poker.hong.10"] = new Hong10PNG();
			...
			_res["poker.mei.4"] = new Mei4PNG();
			_res["poker.mei.5"] = new Mei5PNG();
			_res["poker.mei.6"] = new Mei6PNG();
			_res["poker.mei.7"] = new Mei7PNG();
			_res["poker.mei.8"] = new Mei8PNG();
			_res["poker.mei.9"] = new Mei9PNG();
			_res["poker.mei.10"] = new Mei10PNG();
			...
			_res["poker.fang.4"] = new Fang4PNG();
			_res["poker.fang.5"] = new Fang5PNG();
			_res["poker.fang.6"] = new Fang6PNG();
			_res["poker.fang.7"] = new Fang7PNG();
			_res["poker.fang.8"] = new Fang8PNG();
			_res["poker.fang.9"] = new Fang9PNG();
			_res["poker.fang.10"] = new Fang10PNG();
