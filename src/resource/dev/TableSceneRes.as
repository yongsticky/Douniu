package resource.dev
{
	...
	public class TableSceneRes
	{
		...
		public function TableSceneRes()
		{
			...
			_res["table.timer_0"] = new Time0PNG();
			_res["table.timer_1"] = new Time1PNG();
			_res["table.timer_2"] = new Time2PNG();
			_res["table.timer_3"] = new Time3PNG();
			_res["table.timer_4"] = new Time4PNG();
			_res["table.timer_5"] = new Time5PNG();
			_res["table.timer_6"] = new Time6PNG();
			_res["table.timer_7"] = new Time7PNG();
			_res["table.timer_8"] = new Time8PNG();
			_res["table.timer_9"] = new Time9PNG();			
			_res["table.timer_bg"] = new TimeBgPNG();
