...
{			
	...
	public class NiuServerResponseReceiver
	{
		private var _logger:ILogger;		
		
		public function NiuServerResponseReceiver()
		{
			_logger = Logger.createLogger(NiuServerResponseReceiver, LEVEL.DEBUG);
		}
		
		public static function instance() : NiuServerResponseReceiver
		{
			return Singleton.instanceOf(NiuServerResponseReceiver);
		}
		...
		protected function onReceive_Login(event:PacketEvent) : void
		{
			...
			NiuServerRequestSender.instance().sendRequest(sitdownRequest);
		}
		...
		protected function onReceive_Sitdown(event:PacketEvent) : void
		{
			...
			NiuServerRequestSender.instance().sendRequest(readyRequest);
		}
		...
		protected function onReceive_Ready(event:PacketEvent) : void
		{
			...
			NiuServerRequestSender.instance().sendRequest(standupRequest);			
		}
		...
		protected function onReceive_Standup(event:PacketEvent) : void
		{
			...
			NiuServerRequestSender.instance().sendRequest(logoutReqeust);
